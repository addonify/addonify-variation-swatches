...
<ul class="<?php echo esc_attr( $css_class ); ?>">
	...
	<?php foreach ( $options as $option_slug => $option_name ) : ?>
		<li data-value="<?php echo esc_attr( $option_slug ); ?>" data-title="<?php echo esc_attr( $option_name ); ?>" > <span class="adfy-vs adfy-color-vs" style="background-color:<?php echo esc_attr( $option_slug ); ?>" ></span></li>
	<?php endforeach; ?>
