...
<ul class="<?php echo esc_attr( $css_class ); ?>" >
	...
	<?php foreach ( $options as $option_slug => $option_name ) : ?>
		<li data-value="<?php echo esc_attr( $option_slug ); ?>" data-title="<?php echo esc_attr( $option_name[1] ); ?>" >
		<img class="adfy-vs adfy-image-vs" src="<?php echo esc_attr( $option_name[0] ); ?>" placeholder="<?php echo esc_attr( $option_name[1] ); ?>">
	</li>
	<?php endforeach; ?>
